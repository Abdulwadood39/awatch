...
from awatch.capture.logging_bridge import install_log_capture, pop_logs
from awatch.capture.sampling import should_sample_request
from awatch.core.constants import REQUEST_ID_HEADER
from awatch.core.context import (
    get_categories,
    get_consumer,
    get_spans,
