...
from awatch.analytics.consumer_rules import compile_consumer_defs
from awatch.analytics.categories.loaders import _build_rule
from awatch.analytics.categories.rules import CategoryRule
